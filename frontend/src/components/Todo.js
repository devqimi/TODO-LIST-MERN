...
function Todo(){
    ...
    const saveEditedTask = (id) => {
        ...
        axios.post('https://127.0.0.1:3001/updateTodoList' + id, editedData)
            .then(result => {
                console.log(result);
                setEditableId(null);
                setEditedTask("");
    ...
    const deleteTask = (id) => {
        axios.delete('https://127.0.0.1:3001/deleteTodoList' + id)
         .then(result => {
            console.log(result);
            window.location.reload();
         })
                                        ...
                                        <tr key={data._id}>
                                            ...
                                            <td>
                                                {editableId === data._id ? (
                                                    ...
                                                    data.deadline ? new Date(data.deadline).localeString() : ''
                                                )}
                                            </td>
                                            <td>
                                                {editableId === data._id ? (
